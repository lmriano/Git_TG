...
//SQL para consultas Deportistas

$sqlPacientes = ('SELECT COUNT(*) AS count FROM usuarios WHERE num_documento = :documento AND id_tipo = 3');
//$sqlTrabajadores = ("SELECT * FROM trabajadores");
$query = mysqli_query($con, $sqlPacientes);
